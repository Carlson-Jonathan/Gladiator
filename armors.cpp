...
{"Naked"      , {{{ "" },  { 0 }},  {{   0,   0,   0,  60, 30,  0, -60 },  { 0.3, 0.3, 0.3, 0.1 }}}},
{"Fighting Gi", {{{ "" },  { 0 }},  {{  20, 200,  20,  50, 25, 50, -50 },  { 0.1, 0.3, 0.3, 0.3 }}}},
{"Pads",        {{{ "" },  { 0 }},  {{  70, 200,  80,  20, 20, 50, -10 },  { 0.7, 0.3, 0.0, 0.0 }}}},
{"Leather",     {{{ "" },  { 0 }},  {{  50, 200,  90,  30, 15, 60, -20 },  { 0.3, 0.2, 0.2, 0.3 }}}},
{"Ring",        {{{ "" },  { 0 }},  {{  75, 200, 140,  10, 10, 70,   0 },  { 0.1, 0.7, 0.3, 0.1 }}}},
{"Chain",       {{{ "" },  { 0 }},  {{ 125, 200, 190, -10, 10, 80,  10 },  { 0.0, 0.2, 0.7, 0.1 }}}},
{"Scale",       {{{ "" },  { 0 }},  {{ 150, 200, 220, -20,  5, 90,  20 },  { 0.0, 0.1, 0.2, 0.7 }}}},
{"Plate",       {{{ "" },  { 0 }},  {{ 250, 200, 300, -30,  0, 100, 30 },  { .25, .25, .25, .25 }}}}}; 
