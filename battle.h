...
void Battle::killMonster() {
   ...
   for(int i = combatParticipants.size() - 1; i >= 0; i--) {
      ...
      if(debugMode) cout << "Checking for defeat condition of combatParticipants[" 
                         << i << "] : " << combatParticipants[i]->name << "\n\n";
      if(combatParticipants[i]->isDead) {
         if(combatParticipants[i]->isHero) {
            cout << "WARNING! Hero object is flagged as 'dead'.\n\n"; 
            break;
         }
         ...
         cout << "Armor pointer nullified.\n";

         if(debugMode)cout << "Calling 'delete' on object in sorting list, combatParticipants[" 
                           << (i) << "]" << endl; 
         ...
         if(debugMode) cout << "Pointer nullified!\n";
         if(debugMode)cout << "Erasing object " << (*(combatParticipants.begin() + i)) 
...
*******************************************************************************/
   ...
   void Battle::combat(Character & player, string newMonster, 
      ...
      this->player = player;
                  ...
                  // Global variable. Toggle in main.cpp
...
// Bugs to fix:
// Weird crash on weapon object destoy.
