...
//            |        |             |                                                                |   |      Attack         |          Armor         |  
//  Key       |    AD  | placeholder |  HP    BP    EP   Init Min   Rg Vnm Stn Hz  Pr  Ev  Pb  Cb  Eb |   | Cr   Ch   Sl   St   |  Cr    Ch    Sl    St  |  CrM CrC Rp  Db
{"Skeleton",  {{{ a[0] },  { 0 }},  {{ 1000, 1000, 1000,  80, 100,  50, 0,  0,  0, 80, 20,  0,  1, 10 },  { 0.0, 0.1, 0.7, 0.2,   -1.0, -0.5,  0.4,  1.0,     3, 10, 0, 50 }}}},
{"Slime",     {{{ a[1] },  { 0 }},  {{ 1000, 1000, 1000, 160, 100,  50, 10, 0,  0, 80,  0,  0,  1, 10 },  { 1.0, 0.0, 0.0, 0.0,    0.7, -0.2, -0.5,  0.0,     3, 10, 0, 50 }}}},
{"Snake",     {{{ a[2] },  { 0 }},  {{ 1000, 1000, 1000, 100,  30,  20, 10, 0,  0, 90, 30,  0,  1, 10 },  { 0.0, 0.0, 0.1, 0.9,    0.6, -0.6, -0.3,  0.5,     3, 10, 0, 50 }}}},
{"Wolf",      {{{ a[3] },  { 0 }},  {{ 1000,  100, 1000, 100,  50,  50, 0,  0,  0, 70,-50,  0,  1, 10 },  { 0.1, 0.7, 0.1, 0.1,    0.4,  0.5,  0.2, -0.7,     4,  2, 0, 50 }}}},
