...
//            |        |             |                                                                     |   |      Attack         |          Armor         |  
//  Key       |    AD  | placeholder |  HP    BP    EP   Init Min   Rg Vnm Stn Hz  Pr   Ev  Pb  Cb  Eb, Dp |   | Cr   Ch   Sl   St   |  Cr    Ch    Sl    St  | CrM  CrC  Rp  Db
{"Skeleton",  {{{ a[0] },  { 0 }},  {{ 1000, 1000, 1000,  80, 100,  50, 0,  0,  0, 80,   0,  0,  1, 10, 100 },  { 0.0, 0.1, 0.7, 0.2,   -1.0, -0.5,  0.4,  1.0,    3,  10,  0, 50 }}}},
{"Slime",     {{{ a[1] },  { 0 }},  {{ 1000, 1000, 1000, 160, 100,  50, 10, 0,  0, 80, -30,  0,  1, 10, 100 },  { 1.0, 0.0, 0.0, 0.0,    0.7, -0.2, -0.5,  0.0,    3,  10,  0, 50 }}}},
{"Snake",     {{{ a[2] },  { 0 }},  {{ 1000, 1000, 1000, 100,  30,  20, 10, 0,  0, 90,  20,  0,  1, 10, 100 },  { 0.0, 0.0, 0.1, 0.9,    0.6, -0.6, -0.3,  0.5,    3,  10,  0, 50 }}}},
{"Wolf",      {{{ a[3] },  { 0 }},  {{ 1000,  100, 1000, 100,  50,  50, 0,  0,  0, 70,  10,  0,  1, 10, 100 },  { 0.1, 0.7, 0.1, 0.1,    0.4,  0.5,  0.2, -0.7,    4,   2,  0, 50 }}}},
{"Wasp",      {{{ a[4] },  { 0 }},  {{ 1000, 1000, 1000,  70,  20,  20, 0,  0,  0, 80,  40,  0,  1, 10, 100 },  { 0.0, 0.0, 0.1, 0.9,   -0.7,  0.2,  0.1,  0.0,  3.5,   4,  0, 50 }}}},
{"Zombie",    {{{ a[5] },  { 0 }},  {{ 1000, 1000, 1000, 200, 200,  50, 0,  0,  0, 60, -25,  0,  1, 10, 100 },  { 0.7, 0.3, 0.0, 0.0,    0.7, -0.7,  0.6,  0.8,    3,  10,  0, 50 }}}},
{"Duckling",  {{{ a[6] },  { 0 }},  {{   15,   20, 1000,  50,  10,  30, 0,  0,  0, 90,  50,  0,  1, 10, 100 },  { 0.0, 0.0, 0.0, 1.0,   0.95, 0.95, 0.95, 0.95,    3,  10,  0, 50 }}}},
{"Cactopus",  {{{ a[7] },  { 0 }},  {{ 1000, 1000, 1000, 150,  20,  30, 0,  0,  2, 80, -10,  0,  1, 10, 100 },  { 0.3, 0.0, 0.3, 0.4,    0.3, -0.5, -0.2,  0.5,    3,  10,  0, 50 }}}},
