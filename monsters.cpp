...
//  Key       |    AD  | placeholder |  HP    BP    EP   Init Min   Rn Vnm Stn Hz  Pr   Ev   Pb  Cb  Eb, Dp   Rg  Bl CRC |   | Cr   Ch   Sl   St   |  Cr    Ch    Sl    St  | CrM  Rp  Db
{"Skeleton",  {{{ a[0] },  { 0 }},  {{ 1000, 1000, 1000,  80, 100,  50, 0,  0,  0, 80,   0,  25,  2, 20, 100,  0, 10, 10 },  { 0.0, 0.1, 0.7, 0.2,   -1.0, -0.5,  0.4,  1.0,   3,  0,  50  }}}},
{"Slime",     {{{ a[1] },  { 0 }},  {{ 1000, 1000, 1000, 160, 100,  50, 10, 0,  0, 80, -30,  25,  2, 20, 100,  0,  0, 10 },  { 1.0, 0.0, 0.0, 0.0,    0.7, -0.2, -0.5,  0.0,   3,  0,  50  }}}},
{"Snake",     {{{ a[2] },  { 0 }},  {{ 1000, 1000, 1000, 100,  30,  20, 10, 0,  0, 90,  20,  25,  2, 20, 100,  0, 10, 10 },  { 0.0, 0.0, 0.1, 0.9,    0.6, -0.6, -0.3,  0.5,   3,  0,  50  }}}},
{"Wolf",      {{{ a[3] },  { 0 }},  {{ 1000,  100, 1000, 100,  50,  50, 0,  0,  0, 70,  10,  25,  2, 20, 100,  0,100,  4 },  { 0.1, 0.7, 0.1, 0.1,    0.4,  0.5,  0.2, -0.7,   4,  0,  50  }}}},
{"Wasp",      {{{ a[4] },  { 0 }},  {{ 1000, 1000, 1000,  70,  20,  20, 0,  0,  0, 80,  40,  25,  2, 20, 100,  0,  0,  4 },  { 0.0, 0.0, 0.1, 0.9,   -0.7,  0.2,  0.1,  0.0, 3.5,  0,  50  }}}},
{"Zombie",    {{{ a[5] },  { 0 }},  {{ 1000, 1000, 1000, 200, 200,  50, 0,  0,  0, 60, -25,  25,  2, 20, 100,  0,  0, 10 },  { 0.7, 0.3, 0.0, 0.0,    0.7, -0.7,  0.6,  0.8,   3,  0,  50  }}}},
{"Duckling",  {{{ a[6] },  { 0 }},  {{   15,   20, 1000,  50,  10,  30, 0,  0,  0, 90,  50,  25,  2, 20, 100,  0,  5, 10 },  { 0.0, 0.0, 0.0, 1.0,   0.95, 0.95, 0.95, 0.95,   3,  0,  50  }}}},
{"Cactopus",  {{{ a[7] },  { 0 }},  {{ 1000, 1000, 1000, 150,  20,  30, 0,  0,  2, 80, -10,  25,  2, 20, 100,  0, 10, 10 },  { 0.3, 0.0, 0.3, 0.4,    0.3, -0.5, -0.2,  0.5,   3,  0,  50  }}}},
{"Troll",     {{{ a[8] },  { 0 }},  {{ 1000, 1000, 1000, 110,  60,  40, 0, 100, 0, 80,   0,  25,  2, 20, 100, 40,  0,  7 },  { 0.3, 0.2, 0.2, 0.1,    0.4,    0, -0.7, -0.3,   4,  0,  50  }}}},
{"Omnibeast", {{{ a[9] },  { 0 }},  {{ 1000, 1000, 1000, 110,  30,  30, 5, 100, 4, 80,  20,  25,  2, 20, 100, 20, 20,  8 },  { 0.6, 0.6, 0.6, 0.6,    0.5,  0.5,  0.5,  0.5,   6, .5,  100 }}}},
